...
const RELEVANCE_RULES: Record<EventCategory, Record<ActivityType, { sentiment: EventSentiment; reason: string }>> = {
  'major-regatta': {
    ...
    fishing_boat:    { sentiment: 'caution', reason: 'Fun to spectate — stay clear of race course' },
    fishing_kayak:  { sentiment: 'avoid',   reason: 'Large racing fleet — dangerous for small craft' },
  },
  'club-regatta': {
    ...
    fishing_boat:    { sentiment: 'neutral', reason: 'Club racing nearby — minor congestion' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Racing near this area — stay clear of start/finish' },
  },
  'one-design': {
    ...
    fishing_boat:    { sentiment: 'neutral', reason: 'One-design racing nearby' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Fleet racing nearby — give them room' },
  },
  'midwinter': {
    ...
    fishing_boat:    { sentiment: 'neutral', reason: 'Midwinter racing nearby' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Winter racing — limited rescue resources' },
  },
  'beer-can': {
    ...
    fishing_boat:    { sentiment: 'neutral', reason: 'Casual evening racing nearby' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Evening racing fleet nearby — be visible' },
  },
  'offshore': {
    ...
    fishing_boat:    { sentiment: 'caution', reason: 'Fleet departing Bay — congestion at Gate' },
    fishing_kayak:  { sentiment: 'neutral', reason: 'Offshore race — starts in Bay then heads to sea' },
  },
  'foil-race': {
    ...
    fishing_boat:    { sentiment: 'caution', reason: 'High-speed foil racing — unpredictable fast traffic' },
    fishing_kayak:  { sentiment: 'avoid',   reason: 'High-speed foils (30+ knots) — extremely dangerous for small craft' },
  },
  'boat-show': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Boat show — dock and browse' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Boat show — crowded marina, fun to paddle past' },
  },
  'parade': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Join or spectate the parade' },
    fishing_kayak:  { sentiment: 'avoid',   reason: 'Parade route with restricted zones — not safe for kayaks' },
  },
  'fleet-week': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Blue Angels from the water — follow USCG rules' },
    fishing_kayak:  { sentiment: 'avoid',   reason: 'USCG restricted zones — kayaks prohibited in air show box' },
  },
  'lighted-parade': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Lighted boat parade — decorate and join!' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Nighttime parade — low visibility for small craft' },
  },
  'holiday': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Holiday on the water — join the flotilla' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Holiday crowds — heavy boat traffic, stay visible' },
  },
  'swim': {
    ...
    fishing_boat:    { sentiment: 'avoid',   reason: 'USCG swim corridor — vessels prohibited in course area' },
    fishing_kayak:  { sentiment: 'avoid',   reason: 'USCG swim corridor — vessels prohibited in course area' },
  },
  'paddle': {
    ...
    fishing_boat:    { sentiment: 'caution', reason: 'Paddle event — many small craft in area, slow wake' },
    fishing_kayak:  { sentiment: 'fun',     reason: 'Paddle event — join or cheer from the water' },
  },
  'dragon-boat': {
    ...
    fishing_boat:    { sentiment: 'neutral', reason: 'Dragon boat racing in protected lagoon — no Bay impact' },
    fishing_kayak:  { sentiment: 'neutral', reason: 'Dragon boat racing in protected lagoon — no Bay impact' },
  },
  'fishing': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Fishing derby — grab your rod' },
    fishing_kayak:  { sentiment: 'fun',     reason: 'Fishing event — kayak anglers welcome' },
  },
  'heritage': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Maritime heritage event — worth a visit' },
    fishing_kayak:  { sentiment: 'fun',     reason: 'Maritime heritage event — paddle by for a look' },
  },
  'youth': {
    ...
    fishing_boat:    { sentiment: 'caution', reason: 'Youth regatta — slow wake, give room' },
    fishing_kayak:  { sentiment: 'caution', reason: 'Youth regatta — many inexperienced sailors, give room' },
  },
  'community': {
    ...
    fishing_boat:    { sentiment: 'fun',     reason: 'Community event — worth a stop' },
    fishing_kayak:  { sentiment: 'fun',     reason: 'Community event — check it out' },
  },
};
